defmodule SpiderWeb.ExportZoneLivestockOrderController do
  ...
  def index(conn, _params) do
    export_zone_livestock_orders = ExportZoneLivestockOrders.list_export_zone_livestock_orders()
    render(
      conn, "index.json", 
      export_zone_livestock_orders: export_zone_livestock_orders
      |> Repo.preload([
          export_zone_bundler: [
            business: [
              business_assets: [], 
  ...
  def create(conn, %{"export_zone_livestock_order" => export_zone_livestock_order_params}) do
    with {:ok, %ExportZoneLivestockOrder{} = export_zone_livestock_order} <- ExportZoneLivestockOrders.create_export_zone_livestock_order(export_zone_livestock_order_params) do
      ...
      |> render(
        "show.json", 
        export_zone_livestock_order: export_zone_livestock_order 
        |> Repo.preload([
          export_zone_bundler: [
            business: [
              business_assets: [], 
